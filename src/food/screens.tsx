...
const styles = StyleSheet.create({
  flex: { flex: 1 },
  itemScroll: { paddingHorizontal: 20, paddingBottom: 130, gap: 22 },
  itemHeroWrap: { height: 248, borderRadius: 24, overflow: 'hidden', backgroundColor: COLORS.surfaceStrong, position: 'relative' },
  ...
  itemTitle: { fontFamily: FONT.bold, fontWeight: '900', fontSize: 28, lineHeight: 33, color: COLORS.black, marginTop: 5 },
  itemDescription: { ...TYPE.body, color: COLORS.muted, lineHeight: 21, marginTop: 9 },
  ...
  optionRow: { minHeight: 62, flexDirection: 'row', alignItems: 'center', gap: 12 },
  ...
  quantitySection: { minHeight: 74, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  quantityControl: { height: 46, borderRadius: 15, borderWidth: 1, borderColor: COLORS.line, flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.white },
  quantityButton: { width: 45, height: 44, alignItems: 'center', justifyContent: 'center' },
  quantityValue: { width: 34, textAlign: 'center', ...TYPE.bodyStrong, color: COLORS.black },
  stickyFooter: { position: 'absolute', left: 0, right: 0, bottom: 0, minHeight: 92, borderTopWidth: 1, borderTopColor: COLORS.line, backgroundColor: COLORS.white, paddingHorizontal: 20, paddingVertical: 14, flexDirection: 'row', alignItems: 'center', gap: 18, ...SHADOW },
  footerLabel: { ...TYPE.caption, color: COLORS.muted },
  footerTotal: { ...TYPE.sectionTitle, color: COLORS.black, marginTop: 2 },
  footerButton: { flex: 1 },
  checkoutScroll: { paddingHorizontal: 20, paddingBottom: 34, gap: 22 },
  ...
  segmented: { height: 58, padding: 4, borderRadius: 18, borderWidth: 1, borderColor: COLORS.line, backgroundColor: COLORS.surface, flexDirection: 'row', gap: 4 },
  segment: { flex: 1, borderRadius: 14, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 7 },
  ...
  addressCard: { minHeight: 78, flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 14, shadowOpacity: 0 },
  pickupCard: { minHeight: 78, flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 14, backgroundColor: '#FFF9E1', shadowOpacity: 0 },
  ...
  choiceChip: { height: 42, paddingHorizontal: 14, borderRadius: 14, borderWidth: 1, borderColor: COLORS.line, backgroundColor: COLORS.white, alignItems: 'center', justifyContent: 'center' },
  ...
  instructionCard: { width: '48.5%', minHeight: 50, borderRadius: 14, borderWidth: 1, borderColor: COLORS.line, paddingHorizontal: 12, alignItems: 'center', justifyContent: 'center' },
  ...
  couponInputWrap: { flex: 1, height: 52, borderRadius: 15, borderWidth: 1, borderColor: COLORS.line, flexDirection: 'row', alignItems: 'center', gap: 9, paddingHorizontal: 13 },
  couponInput: { flex: 1, ...TYPE.body, color: COLORS.black, paddingVertical: 0 },
  applyButton: { minWidth: 76, height: 52, borderRadius: 15, backgroundColor: COLORS.black, alignItems: 'center', justifyContent: 'center' },
  ...
  tipChip: { minWidth: 72, height: 40, paddingHorizontal: 12, borderRadius: 13, borderWidth: 1, borderColor: COLORS.line, alignItems: 'center', justifyContent: 'center' },
  ...
  paymentRow: { minHeight: 70, borderBottomWidth: 1, borderBottomColor: COLORS.line, flexDirection: 'row', alignItems: 'center', gap: 12 },
  ...
  successScroll: { flexGrow: 1, paddingHorizontal: 24, paddingTop: 54, paddingBottom: 30, alignItems: 'stretch', gap: 18 },
  successIcon: { width: 82, height: 82, borderRadius: 41, backgroundColor: COLORS.green, alignItems: 'center', justifyContent: 'center', alignSelf: 'center' },
  successTitle: { fontFamily: FONT.bold, fontSize: 30, lineHeight: 35, fontWeight: '900', color: COLORS.black, textAlign: 'center' },
